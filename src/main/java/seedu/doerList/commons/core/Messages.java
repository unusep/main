...
public class Messages {
    ...
    public static final String MESSAGE_UNKNOWN_COMMAND = "Unknown command - Please type 'help' to bring up the User Guide or 'help [COMMAND_NAME]' to view the instruction for specific command";
